...
public class MessageEmbed implements SerializableData {
    ...
    /**
     * The information about the {@link Thumbnail Thumbnail} image to be displayed with the embed.
     * <br>If a {@link Thumbnail Thumbnail} was not part of this embed, this returns null.
     *
     * @return Possibly-null {@link Thumbnail Thumbnail} instance
     ...
     *
     * @return Possibly-null {@link Provider Provider}
     ...
     *
     * @return Possibly-null {@link AuthorInfo AuthorInfo}
     ...
     *
     * @return Possibly-null {@link VideoInfo VideoInfo}
     ...
     *
     * @return Possibly-null {@link Footer Footer}
     ...
     *
     * @return Possibly-null {@link ImageInfo ImageInfo}
     ...
     *
     * @return Never-null (but possibly empty) immutable  List of {@link Field Field} objects
    ...
    public int getLength() {
        ...
        synchronized (mutex) {
            ...
            if (description != null)
                length += UnicodeMeasurement.getActualLength(description);
            if (author != null)
            ...
            if (fields != null) {
                for (Field f : fields)
                    length += UnicodeMeasurement.getActualLength(f.getName()) + UnicodeMeasurement.getActualLength(f.getValue());
            }
     ...
     * </ul>
     *
     * @param type The {@link AccountType AccountType} to inspect
     * @return True, if this MessageEmbed can be used to send messages for this specified AccountType
     * @throws IllegalArgumentException If the provided AccountType is {@code null} or not supported by this operation
     * @see #getLength()
    ...
    public static class Field {
        ...
        public Field(String name, String value, boolean inline, boolean checked) {
            if (checked) {
                ...
                else if (UnicodeMeasurement.getActualLength(name) > TITLE_MAX_LENGTH)
                    throw new IllegalArgumentException("Name cannot be longer than " + TITLE_MAX_LENGTH + " characters.");
                else if (UnicodeMeasurement.getActualLength(value) > VALUE_MAX_LENGTH)
