...
public interface MessageChannel extends ISnowflake, Formattable
{
    ...
    default MessageAction sendMessage(@Nonnull CharSequence text)
    {
        ...
        Checks.check(UnicodeMeasurement.getActualLength(text) <= 2000, "Provided text for message must be less than 2000 characters in length");
    ...
    default RestAction<Message> retrieveMessageById(@Nonnull String messageId)
    {
        ...
        return new RestActionImpl<>(jda, route,(response, request) -> jda.getEntityBuilder().createMessage(response.getObject(), MessageChannel.this, false));
    }
    ...
    default MessageAction editMessageById(@Nonnull String messageId, @Nonnull CharSequence newContent)
    {
        ...
        Checks.check(UnicodeMeasurement.getActualLength(newContent) <= 2000, "Provided newContent length must be 2000 or less characters.");
